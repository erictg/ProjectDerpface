...
namespace ProjectDerpface.Framework.Managers.BEPUmanagment
{
    ...
    public abstract class Stage1
    {
        ...
        public virtual void CleanUp()
        {
            ...
            ProjectDerpface.Framework.BEPUextensions.ConfigurationHelper.ApplyDefaultSettings(Space);
