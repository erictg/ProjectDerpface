...
using ProjectDerpface.Framework.Managers.BEPUmanagment;
using ProjectDerpface.Framework.BEPUextensions;
namespace ProjectDerpface.Framework.Managers
{
    public class InGameManager : Stage2
    {
        /// <summary>
        /// Constructs a new demo.
        /// </summary>
        /// <param name="game">Game owning this demo.</param>
        public InGameManager(Game1 game)
            : base(game)
        {
